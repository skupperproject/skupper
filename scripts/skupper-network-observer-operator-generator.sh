...
readonly SKUPPER_IMAGE_TAG=${1:-2.2.1}

readonly OPERATOR_SDK=${OPERATOR_SDK:-operator-sdk}
readonly KUBECTL=${KUBECTL:-kubectl}
readonly MIN_KUBE_VERSION=${MIN_KUBE_VERSION:-1.25.0}

readonly BUNDLE_VERSION=${BUNDLE_VERSION:-2.2.1}
readonly PREVIOUS_BUNDLE_VERSION=${PREVIOUS_BUNDLE_VERSION:-2.2.0}
...
readonly OLM_SKIP_RANGE='">2.2.1 <2.2.2"'
