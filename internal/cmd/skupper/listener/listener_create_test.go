	...
	testTable := []test{
		...
		},
		{
			...
			setUpMock: func(command *CmdListenerCreate) {
				...
				fakeSkupperClient.Fake.ClearActions()
				command.client = fakeSkupperClient
				command.flags = ListenerFlags{listenerType: "not-valid"}
			},
			expectedErrors: []string{
		...
		},
		{
			...
			setUpMock: func(command *CmdListenerCreate) {
				...
				fakeSkupperClient.Fake.ClearActions()
				command.client = fakeSkupperClient
				command.flags = ListenerFlags{routingKey: "not-valid$"}
			},
			expectedErrors: []string{
		...
		},
		{
			...
			setUpMock: func(command *CmdListenerCreate) {
				...
				fakeSkupperClient.Fake.ClearActions()
				command.client = fakeSkupperClient
				command.flags = ListenerFlags{host: ":not-Valid"}
			},
			expectedErrors: []string{
		...
		},
		{
			...
			setUpMock: func(command *CmdListenerCreate) {
				...
				fakeSkupperClient.Fake.ClearActions()
				command.client = fakeSkupperClient
				command.flags = ListenerFlags{tlsSecret: "not-valid"}
