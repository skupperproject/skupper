...
func TestNonKubeCmdConnectorCreate_InputToOptions(t *testing.T) {
	...
	testTable := []test{
		{
			name:                   "test1",
			flags:                  common.CommandConnectorCreateFlags{"backend", "", "", "secret", "tcp", false, "", 0, "none"},
		...
		},
		{
			name:                   "test2",
			namespace:              "test",
			flags:                  common.CommandConnectorCreateFlags{"backend", "1.2.3.4", "", "secret", "tcp", false, "", 0, "configured"},
			expectedTlsCredentials: "secret",
		...
		},
		{
			name:                   "test3",
			namespace:              "test",
			flags:                  common.CommandConnectorCreateFlags{"", "localhost", "", "secret", "tcp", false, "", 0, "ready"},
			expectedTlsCredentials: "secret",
