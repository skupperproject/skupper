...
const (
	...
	ControllerImageName       string = "controller:2.1.4"
	KubeAdaptorImageName      string = "kube-adaptor:2.1.4"
	NetworkObserverImageName  string = "network-observer:2.1.4"
	CliImageName              string = "cli:2.1.4"
	SystemControllerImageName string = "system-controller:2.1.4"
