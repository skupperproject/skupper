...
func NewCmdExpose(newClient cobraFunc) *cobra.Command {
	...
	cmd.Flags().BoolVar(&exposeOpts.EnableTls, "enable-tls", false, "If specified, this service will have TLS support towards the router.")
...
func NewCmdCreateService(newClient cobraFunc) *cobra.Command {
	...
	cmd.Flags().BoolVar(&serviceToCreate.EnableTls, "enable-tls", false, "If specified, this service will have TLS support towards the router.")
