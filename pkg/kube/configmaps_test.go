...
func TestNewConfigMap(t *testing.T) {
	...
	for _, test := range testTable {
		t.Run(test.name, func(t *testing.T) {
			// call NewConfigMap
			cm, err := NewConfigMap(test.cmName, test.data, test.labels, test.annotations, test.owner, &ConfigMapManager{KubeClient: kubeClient, Namespace: NS})
...
func TestUpdateSkupperServices(t *testing.T) {
	...
	for _, test := range testTable {
		t.Run(test.name, func(t *testing.T) {
			...
			// Validating results
			err := UpdateSkupperServices(test.changed, test.deleted, "", &ConfigMapManager{KubeClient: kubeClient, Namespace: NS})
