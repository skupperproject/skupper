...
const (
	...
	ServiceControllerImageName string = "service-controller:1.4.4"
	ConfigSyncImageName        string = "config-sync:1.4.4"
	FlowCollectorImageName     string = "flow-collector:1.4.4"
	SiteControllerImageName    string = "site-controller:1.4.4"
