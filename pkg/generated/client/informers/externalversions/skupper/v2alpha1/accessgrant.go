	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().AccessGrants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().AccessGrants(namespace).Watch(context.TODO(), options)
			},
		},
		&skupperv2alpha1.AccessGrant{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accessGrantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&skupperv2alpha1.AccessGrant{}, f.defaultInformer)
}

func (f *accessGrantInformer) Lister() v2alpha1.AccessGrantLister {
	return v2alpha1.NewAccessGrantLister(f.Informer().GetIndexer())
}
