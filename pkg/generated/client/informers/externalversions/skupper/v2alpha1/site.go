	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().Sites(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Sites(namespace).Watch(context.TODO(), options)
			},
		},
		&skupperv2alpha1.Site{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *siteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&skupperv2alpha1.Site{}, f.defaultInformer)
}

func (f *siteInformer) Lister() v2alpha1.SiteLister {
	return v2alpha1.NewSiteLister(f.Informer().GetIndexer())
}
