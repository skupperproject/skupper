	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().Connectors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().Connectors(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *connectorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&skupperv2alpha1.Connector{}, f.defaultInformer)
}

func (f *connectorInformer) Lister() v2alpha1.ConnectorLister {
	return v2alpha1.NewConnectorLister(f.Informer().GetIndexer())
}
