	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SkupperV2alpha1().AttachedConnectors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SkupperV2alpha1().AttachedConnectors(namespace).Watch(context.TODO(), options)
			},
		},
		&skupperv2alpha1.AttachedConnector{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *attachedConnectorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&skupperv2alpha1.AttachedConnector{}, f.defaultInformer)
}

func (f *attachedConnectorInformer) Lister() v2alpha1.AttachedConnectorLister {
	return v2alpha1.NewAttachedConnectorLister(f.Informer().GetIndexer())
}
