...
func (c *accessGrants) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.AccessGrant, err error) {
	result = &v2alpha1.AccessGrant{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *accessGrants) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.AccessGrantList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.AccessGrantList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("accessgrants").
...
func (c *accessGrants) Create(ctx context.Context, accessGrant *v2alpha1.AccessGrant, opts v1.CreateOptions) (result *v2alpha1.AccessGrant, err error) {
	result = &v2alpha1.AccessGrant{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("accessgrants").
...
func (c *accessGrants) Update(ctx context.Context, accessGrant *v2alpha1.AccessGrant, opts v1.UpdateOptions) (result *v2alpha1.AccessGrant, err error) {
	result = &v2alpha1.AccessGrant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessgrants").
...
func (c *accessGrants) UpdateStatus(ctx context.Context, accessGrant *v2alpha1.AccessGrant, opts v1.UpdateOptions) (result *v2alpha1.AccessGrant, err error) {
	result = &v2alpha1.AccessGrant{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("accessgrants").
...
func (c *accessGrants) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.AccessGrant, err error) {
	result = &v2alpha1.AccessGrant{}
