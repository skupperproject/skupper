...
func (c *routerAccesses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.RouterAccess, err error) {
	result = &v2alpha1.RouterAccess{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *routerAccesses) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.RouterAccessList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.RouterAccessList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("routeraccesses").
...
func (c *routerAccesses) Create(ctx context.Context, routerAccess *v2alpha1.RouterAccess, opts v1.CreateOptions) (result *v2alpha1.RouterAccess, err error) {
	result = &v2alpha1.RouterAccess{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("routeraccesses").
...
func (c *routerAccesses) Update(ctx context.Context, routerAccess *v2alpha1.RouterAccess, opts v1.UpdateOptions) (result *v2alpha1.RouterAccess, err error) {
	result = &v2alpha1.RouterAccess{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routeraccesses").
...
func (c *routerAccesses) UpdateStatus(ctx context.Context, routerAccess *v2alpha1.RouterAccess, opts v1.UpdateOptions) (result *v2alpha1.RouterAccess, err error) {
	result = &v2alpha1.RouterAccess{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("routeraccesses").
...
func (c *routerAccesses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.RouterAccess, err error) {
	result = &v2alpha1.RouterAccess{}
