...
func (c *securedAccesses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.SecuredAccess, err error) {
	result = &v2alpha1.SecuredAccess{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *securedAccesses) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.SecuredAccessList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.SecuredAccessList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("securedaccesses").
...
func (c *securedAccesses) Create(ctx context.Context, securedAccess *v2alpha1.SecuredAccess, opts v1.CreateOptions) (result *v2alpha1.SecuredAccess, err error) {
	result = &v2alpha1.SecuredAccess{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("securedaccesses").
...
func (c *securedAccesses) Update(ctx context.Context, securedAccess *v2alpha1.SecuredAccess, opts v1.UpdateOptions) (result *v2alpha1.SecuredAccess, err error) {
	result = &v2alpha1.SecuredAccess{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("securedaccesses").
...
func (c *securedAccesses) UpdateStatus(ctx context.Context, securedAccess *v2alpha1.SecuredAccess, opts v1.UpdateOptions) (result *v2alpha1.SecuredAccess, err error) {
	result = &v2alpha1.SecuredAccess{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("securedaccesses").
...
func (c *securedAccesses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.SecuredAccess, err error) {
	result = &v2alpha1.SecuredAccess{}
