...
var attachedconnectorsResource = schema.GroupVersionResource{Group: "skupper.io", Version: "v2alpha1", Resource: "attachedconnectors"}

var attachedconnectorsKind = schema.GroupVersionKind{Group: "skupper.io", Version: "v2alpha1", Kind: "AttachedConnector"}
...
func (c *FakeAttachedConnectors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.AttachedConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(attachedconnectorsResource, c.ns, name), &v2alpha1.AttachedConnector{})
...
func (c *FakeAttachedConnectors) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.AttachedConnectorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(attachedconnectorsResource, attachedconnectorsKind, c.ns, opts), &v2alpha1.AttachedConnectorList{})
...
func (c *FakeAttachedConnectors) Create(ctx context.Context, attachedConnector *v2alpha1.AttachedConnector, opts v1.CreateOptions) (result *v2alpha1.AttachedConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(attachedconnectorsResource, c.ns, attachedConnector), &v2alpha1.AttachedConnector{})
...
func (c *FakeAttachedConnectors) Update(ctx context.Context, attachedConnector *v2alpha1.AttachedConnector, opts v1.UpdateOptions) (result *v2alpha1.AttachedConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(attachedconnectorsResource, c.ns, attachedConnector), &v2alpha1.AttachedConnector{})
...
func (c *FakeAttachedConnectors) UpdateStatus(ctx context.Context, attachedConnector *v2alpha1.AttachedConnector, opts v1.UpdateOptions) (*v2alpha1.AttachedConnector, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(attachedconnectorsResource, "status", c.ns, attachedConnector), &v2alpha1.AttachedConnector{})
...
func (c *FakeAttachedConnectors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(attachedconnectorsResource, c.ns, name), &v2alpha1.AttachedConnector{})
...
func (c *FakeAttachedConnectors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.AttachedConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(attachedconnectorsResource, c.ns, name, pt, data, subresources...), &v2alpha1.AttachedConnector{})
