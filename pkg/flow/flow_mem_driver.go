...
func (fc *FlowCollector) retrieve(request ApiRequest) (*string, error) {
	...
	case Site:
		...
		case "list":
			...
			snf, _ := sortAndFilter(sites, offset, limit)
		...
		case "processes":
			...
			snf, _ := sortAndFilter(processes, offset, limit)
			return listToJSON(snf), nil
		case "routers":
			...
			snf, _ := sortAndFilter(routers, offset, limit)
			return listToJSON(snf), nil
		case "links":
			links := []LinkRecord{}
			if id, ok := vars["id"]; ok {
			...
			snf, _ := sortAndFilter(links, offset, limit)
			return listToJSON(snf), nil
		case "hosts":
			hosts := []HostRecord{}
			if id, ok := vars["id"]; ok {
			...
			snf, _ := sortAndFilter(hosts, offset, limit)
			return listToJSON(snf), nil
		}
	case Host:
		switch handlerName {
	...
	case Router:
		...
		case "flows":
			...
			snf, _ := sortAndFilter(flows, offset, limit)
			return listToJSON(snf), nil
		case "links":
			links := []LinkRecord{}
			if id, ok := vars["id"]; ok {
		...
		case "listeners":
			...
			snf, _ := sortAndFilter(listeners, offset, limit)
			return listToJSON(snf), nil
		case "connectors":
			...
			snf, _ := sortAndFilter(connectors, offset, limit)
			return listToJSON(snf), nil
		}
	case Link:
		switch handlerName {
	...
	case VanAddress:
		...
		case "list":
			...
			snf, _ := sortAndFilter(addresses, offset, limit)
			return listToJSON(snf), nil
		case "item":
			if id, ok := vars["id"]; ok {
		...
		case "flowpairs":
			...
			snf, _ := sortAndFilter(flowPairs, offset, limit)
			return listToJSON(snf), nil
		case "processes":
			processes := []ProcessRecord{}
	...
	case ProcessGroup:
		...
		case "list":
			...
			snf, _ := sortAndFilter(processGroups, offset, limit)
			return listToJSON(snf), nil
		case "item":
			if id, ok := vars["id"]; ok {
	...
	case FlowAggregate:
		...
		case "sitepair-list":
			...
			snf, _ := sortAndFilter(aggregates, offset, limit)
			return listToJSON(snf), nil
		case "sitepair-item":
			if id, ok := vars["id"]; ok {
	...
	case EventSource:
		...
		case "list":
			...
			snf, _ := sortAndFilter(eventSources, offset, limit)
			return listToJSON(snf), nil
		case "item":
			if id, ok := vars["id"]; ok {
