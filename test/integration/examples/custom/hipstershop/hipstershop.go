...
func CreateVAN(t *testing.T, testRunner base.ClusterTestRunner) {
	...
	err = pub1.VanClient.RouterCreate(ctx, *siteConfig, types.DefaultTimeout)
	...
	err = pub2.VanClient.RouterCreate(ctx, *siteConfig, types.DefaultTimeout)
	...
	err = prv1.VanClient.RouterCreate(ctx, *siteConfig, types.DefaultTimeout)
