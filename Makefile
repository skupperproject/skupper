...
CONTAINERFILES := Dockerfile.bootstrap Dockerfile.kube-adaptor Dockerfile.controller Dockerfile.network-observer
SHARED_IMAGE_LABELS = \
...
all: build-cmd build-kube-adaptor build-controller build-bootstrap build-network-observer update-helm-crd
